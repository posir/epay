...
<div class="panel-body">
  <form onsubmit="return saveSetting(this)" method="post" class="form-horizontal" role="form">
	<div class="form-group">
	  ...
	  <div class="col-sm-9"><input type="text" name="login_apiurl" value="<?php echo $conf['login_apiurl']; ?>" class="form-control" placeholder="https://u.suyanw.cn/         要以http://开头，以/结尾"/></div>
	 
	
	</div>
	<div class="form-group"><label class="col-sm-3 control-label">聚合登录API注册地址</label><a href="https://u.suyanw.cn" target="_blank">https://u.suyanw.cn</a></div>
	<div class="form-group">
